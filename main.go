...
//go:generate go run scripts/nodesgen.go -t User,Workspace,Project,Commit,System,Job,JobMetrics,ProcessGroup,Process,ProcessGroupMetrics,LogEntry,LogMetrics,Task,Step -o models/auto_nodes.go
